...
fun main() {
    ...
    val solver = Day17Part2()
    runAndTime(solver, input)
}

class Day17Part2 : Solver {
    ...
    override fun part2(input: List<String>): Long {
        var plan = CubePlan(listOf(listOf(input)))
//        plan.print(0)
        for (round in 0 until 6) {
            val newPlan = plan.nextRoundPart2Rules()
//            newPlan.print(round + 1)
            plan = newPlan
        }
    ...
    class CubePlan(
        ...
        private fun nextRound(inActiveFlipRule: (Int, Int, Int, Int) -> Boolean, activeFlipRule: (Int, Int, Int, Int) -> Boolean): CubePlan {
